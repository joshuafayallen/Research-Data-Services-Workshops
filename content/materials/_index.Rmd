...
knitr::include_graphics("/Users/josh/Dropbox/Research-Data-Services-Workshops/website/static/media/downloading-r.png")
```
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics("/Users/josh/Dropbox/Research-Data-Services-Workshops/website/static/media/mac-stuff-r.png")
```
